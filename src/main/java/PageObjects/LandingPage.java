...
public class LandingPage extends BasePage{
    ...
    By folderName = By.xpath("/html[1]/body[1]/div[5]/div[1]/div[2]/div[1]/div[2]/form[1]/div[1]/label[1]/input[1]");
    ...
    By verifyFolderName = By.xpath("/*[@id=\"contextmenutarget41\"]/div[2]/div/div[1]/div[1]/div/a");
    ...
    public void createFolder(String myFolderName, String emailAddress){
        ...
        waitAndFindElement(folderName).sendKeys(myFolderName);
    ...
    {
        return waitAndFindElement(verifyFolderName).getText();
    }
